...
//        location.reload(false);
   ...
   //     effect = null;
    ...
    function loadfiletotex(ncnt) {
        ...
        if (isStart) {
            ...
            if(texturel!=null) texturel.dispose();
            texturel = null;
            if(texturer!=null) texturer.dispose();
            texturer = null;
            if (video) {
                video.pause();
                video.currentTime = 0;
	    ...
	    texturel = loadtex(self.file[ncnt + 1]);
    ...
    geometry = new THREE.SphereGeometry(100, 128, 64);
 ...
 //   setstereomode();
    ...
    function makeframe2() {
            ...
            ctxl.drawImage(video, 0, 0, vw, vh / 2, 0, 0, vw, vh / 2);
            if (texturel != null) texturel.needsUpdate = true;
            ctxr.drawImage(video, 0, vh / 2, vw, vh / 2, 0, 0, vw, vh / 2);
    ...
    function render() {
	    ...
	    texturel.offset.y=0.0;
	    texturel.repeat.y=0.5;
            material.map = texturel;
            holoplay.render0(scene, camera);
	    texturel.offset.y=0.5;
	    texturel.repeat.y=0.5;
            material.map = texturel;
