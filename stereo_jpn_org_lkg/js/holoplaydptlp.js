...
function HoloPlay(scene, camera, renderer, hiResRender, focalPointVector, constantCenter){
    var scope = this;
    ...
    var nDpt=15;	// Depth level (%)
    var nDptCent=90;	// Depth Center (0-100)
